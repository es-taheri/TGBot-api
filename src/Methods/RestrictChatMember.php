...
class RestrictChatMember
{
    ...
    {
        $class = new (static::class)($this->_request, $this->chat_id, $this->user_id, $this->permissions);
            $this->{$function} = $value;
        foreach ($this as $key => $value):
